Test assignement for junior php developer position.
...
database login information is in sib_login.php
admin login and password are hardcoded into php 
scripts. Login: admin, password: letmein.
- 
